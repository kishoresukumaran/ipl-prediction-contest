              ...
              <div key={player.playerId} className="rounded-lg border border-[var(--app-border)] bg-[var(--app-surface-alt)]/40">
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className="text-xs font-bold text-[var(--app-text-tertiary)] w-5 text-right shrink-0">{index + 1}</span>
                    <div
                    ...
                    <svg
                      className={`h-4 w-4 text-[var(--app-text-tertiary)] transition-transform shrink-0 ${isExpanded ? 'rotate-180' : ''}`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <div className="sm:hidden mt-2 grid grid-cols-2 gap-2">
                    <div className="rounded-md border border-amber-400/35 bg-amber-400/15 px-2 py-1 text-center">
                      <p className="text-[9px] font-semibold uppercase tracking-wide text-amber-300/90">Streaks Attained</p>
                      <p className="text-sm font-black text-amber-300 tabular-nums">{player.streakCount}</p>
                    </div>
                    <div className="rounded-md border border-[var(--app-border)] bg-[var(--app-surface)] px-2 py-1 text-center">
                      <p className="text-[9px] font-semibold uppercase tracking-wide text-[var(--app-text-tertiary)]">Best Length</p>
                      <p className="text-sm font-black text-[var(--app-text)] tabular-nums">{player.longestStreak}</p>
                    </div>
                  </div>
